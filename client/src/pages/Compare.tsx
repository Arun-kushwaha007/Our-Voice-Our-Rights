...
const Compare: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchStateData = async () => {
      ...
      dispatch({ type: 'SET_COMPARISON_DISTRICT', payload: { index: 1, districtId: null } });
      setDistrictsInState([]);
  ...
  return (
    <main className="min-h-screen bg-light-bg text-dark-text p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto">
        ...
        >
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight font-devanagari">{t('compareDistricts')}</h1>
          <p className="mt-4 text-lg max-w-2xl mx-auto font-devanagari">{t('compareSubtitle')}</p>
        </motion.header>
