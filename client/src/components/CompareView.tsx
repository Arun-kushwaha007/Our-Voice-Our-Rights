      ...
      <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-200">
        <ResponsiveContainer width="100%" height={400}>
          ...
          >
            ...
            <Bar
              dataKey={district1Data.district_name}
              fill="#3B82F6"
              radius={[0, 10, 10, 0]}
            />
            <Bar
              dataKey={district2Data.district_name}
              fill="#10B981"
              radius={[0, 10, 10, 0]}
            />
          </BarChart>
        ...
        {metricsToCompare.map((metric, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-lg transition"
            >
              ...
              <div className="flex justify-between items-baseline mt-1">
                ...
                <span className="text-sm text-gray-500">
                  {district2Data.district_name}
                </span>
              </div>

              <p className="text-right text-xs mt-2 text-gray-500">
                {t('highlight')}:{" "}
                <span className="font-semibold text-amber-600">{winner}</span>
              </p>
            </motion.div>
          );
        })}
